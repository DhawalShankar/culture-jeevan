    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
          ...
          >
            <span>📸</span> 500+ Studios Across India
          </span>
          ...
          <div>
            ...
            >
              Discover and instantly book professional studios — from photography
              sets to film productions, podcast booths to dance floors. Your
              creative space, just a click away.
            </p>
          </div>
        ...
        >
          {/* Warm decorative circle behind image */}
          <div
            style={{
              position: "absolute",
              right: "-40px",
          ...
          >
            {/* Placeholder image via picsum - cameraman/photographer themed */}
            <img
              ...
              onError={(e) => {
                ...
                (e.currentTarget.parentElement as HTMLElement)!.innerHTML = `
                  <div style="width:100%;height:100%;display:flex;flex-direction:column;align-items:center;justify-content:center;background:linear-gradient(135deg,#D4B896,#C4703A22);gap:1rem;">
                    <span style="font-size:5rem;">📷</span>
                    <p style="color:#8B5E3C;font-size:0.9rem;font-weight:500;text-align:center;padding:0 2rem;">Your studio photo<br/>goes here</p>
                  </div>`;
              }}
            />
            {/* Warm overlay tint */}
