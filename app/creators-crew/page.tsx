...
// ── MAIN PAGE ─────────────────────────────────────────────────────────────────
export default function CreatorsCrewPage() {
      ...
      >
        ...
        <div
          style={{
            ...
            border: "1px solid rgba(196,112,58,0.08)",
            pointerEvents: "none",
          }}
        />
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          <div style={{ maxWidth: "700px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "1.25rem" }}>
              ...
              <span
                style={{
                  fontSize: "0.68rem", color: "#7A6050", fontWeight: 600,
                  display: "flex", alignItems: "center", gap: "0.3rem",
                }}
              >
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "0.75rem" }}>
              {[
                ...
                >
                  <span style={{ fontFamily: "var(--font-playfair)", fontSize: "1.1rem", fontWeight: 900, color: SKILL_ACCENT }}>
                    {val}
                  </span>
                  <span style={{ fontSize: "0.68rem", color: "#7A6050", textTransform: "uppercase", letterSpacing: "0.06em", fontWeight: 600 }}>
                    {label}
                  </span>
                </div>
              ))}
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          ...
          {filtered.length > 0 ? (
            ...
            >
              ...
              <p style={{ fontSize: "0.875rem", color: "#9B8070" }}>
